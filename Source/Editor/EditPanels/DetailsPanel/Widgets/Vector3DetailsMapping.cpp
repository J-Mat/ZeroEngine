...
namespace Zero
{
	void FVector3DDetailsMapping::UpdateDetailsWidgetImpl(UProperty* Property, const char* ProperyTag)
	{
		...
		ImGui::SameLine();
		m_bEdited |= ImGui::DragFloat("##X", &Value->x, 0.1f, 0.0f, 0.0f, "%.2f");
		ImGui::SameLine();
		...
		ImGui::SameLine();
		m_bEdited |= ImGui::DragFloat("##Y", &Value->y, 0.1f, 0.0f, 0.0f, "%.2f");
		ImGui::SameLine();
		...
		ImGui::SameLine();
		m_bEdited |= ImGui::DragFloat("##Z", &Value->z, 0.1f, 0.0f, 0.0f, "%.2f");
