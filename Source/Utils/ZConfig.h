...
namespace Zero
{
	namespace ZConfig
	{
		static const std::filesystem::path EngineSourceDir = "G:/Toy/ZeroEngine/ZeroEngine/Engine/Source";
		static const std::filesystem::path ProjectRootDir = "G:/Toy/ZeroEngine/ZeroEngine";
