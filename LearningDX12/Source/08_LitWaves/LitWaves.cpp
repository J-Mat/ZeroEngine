...
class FLitWaves : public FD3DApp
{
public:
	FLitWaves(HINSTANCE hInstance);
	~FLitWaves();
...
FLitWaves::FLitWaves(HINSTANCE hInstance)
	: FD3DApp(hInstance)
{
}
...
float FLitWaves::GetHillsHeight(float X, float Z) const
{
	return 0.3f * (Z * sinf(0.1f * X) + X * cosf(0.1f * Z));
}

XMFLOAT3 FLitWaves::GetHillsNormal(float X, float Z) const
{
	XMFLOAT3 N(
...
void FLitWaves::Update(const GameTimer &gt)
{
	OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void FLitWaves::Draw(const GameTimer &gt)
{
...
void FLitWaves::OnMouseDown(WPARAM btnState, int x, int y)
{
	LastMousePos.x = x;
	LastMousePos.y = y;
...
void FLitWaves::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void FLitWaves::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void FLitWaves::OnKeyboardInput(const GameTimer &gt)
{
...
void FLitWaves::UpdateCamera(const GameTimer &gt)
{
...
void FLitWaves::UpdateObjectCBs(const GameTimer &gt)
{
...
void FLitWaves::UpdateMainPassCB(const GameTimer &gt)
{
...
void FLitWaves::UpdateMaterialCBs(const GameTimer& gt)
{
...
void FLitWaves::UpdateWaves(const GameTimer& gt)
{
...
void FLitWaves::BuildRootSignature()
{
...
void FLitWaves::BuildLandGeometry()
{
...
void FLitWaves::BuildWavesGeometryBuffers()
{
...
void FLitWaves::BuildRenderItems()
{
...
void FLitWaves::DrawRenderItems(ID3D12GraphicsCommandList *CommandList, const std::vector<FRenderItem *> &RenderItems)
{
...
void FLitWaves::BuildFrameResources()
{
