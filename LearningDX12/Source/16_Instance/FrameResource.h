...
public:
   ...
   // std::unique_ptr<TUploadBuffer<FrameConstants>> FrameCB = nullptr;
    std::unique_ptr<TUploadBuffer<PassConstants>> PassCB = nullptr;
    std::unique_ptr<TUploadBuffer<MaterialData>> MaterialBuffer = nullptr;
    ...
    std::unique_ptr<TUploadBuffer<InstanceData>> InstanceBuffer = nullptr;
