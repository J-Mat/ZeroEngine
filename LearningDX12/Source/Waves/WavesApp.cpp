...
float FWavesApp::GetHillsHeight(float X, float Z) const
{
	return 0.3f * (Z * sinf(0.1f * X) + X * cosf(0.1f * Z));
}

XMFLOAT3 FWavesApp::GetHillsNormal(float X, float Z) const
{
	XMFLOAT3 N(
...
void FWavesApp::Update(const GameTimer &gt)
{
	OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void FWavesApp::Draw(const GameTimer &gt)
{
...
void FWavesApp::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}
...
void FWavesApp::OnKeyboardInput(const GameTimer &gt)
{
...
void FWavesApp::UpdateCamera(const GameTimer &gt)
{
...
void FWavesApp::UpdateObjectCBs(const GameTimer &gt)
{
...
void FWavesApp::UpdateMainPassCB(const GameTimer &gt)
{
...
void FWavesApp::UpdateWaves(const GameTimer& gt)
{
...
void FWavesApp::BuildRootSignature()
{
...
void FWavesApp::BuildShadersAndInputLayout()
{
	HRESULT hr = S_OK;
...
void FWavesApp::BuildLandGeometry()
{
...
void FWavesApp::BuildWavesGeometryBuffers()
{
...
void FWavesApp::BuildRenderItems()
{
...
void FWavesApp::DrawRenderItems(ID3D12GraphicsCommandList *CommandList, const std::vector<FRenderItem *> &RenderItems)
{
...
void FWavesApp::BuildFrameResources()
{
