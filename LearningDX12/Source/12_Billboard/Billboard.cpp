...
class FBillboard : public FD3DApp
{
public:
	FBillboard(HINSTANCE hInstance);
	~FBillboard();
...
FBillboard::FBillboard(HINSTANCE hInstance)
	: FD3DApp(hInstance)
{
}
...
float FBillboard::GetHillsHeight(float X, float Z) const
{
	return 0.3f * (Z * sinf(0.1f * X) + X * cosf(0.1f * Z));
}

XMFLOAT3 FBillboard::GetHillsNormal(float X, float Z) const
{
	XMFLOAT3 N(
...
void FBillboard::Update(const GameTimer &gt)
{
	OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void FBillboard::Draw(const GameTimer &gt)
{
...
void FBillboard::OnMouseDown(WPARAM btnState, int x, int y)
{
	LastMousePos.x = x;
	LastMousePos.y = y;
...
void FBillboard::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void FBillboard::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void FBillboard::OnKeyboardInput(const GameTimer &gt)
{
...
void FBillboard::UpdateCamera(const GameTimer &gt)
{
...
void FBillboard::UpdateObjectCBs(const GameTimer &gt)
{
...
void FBillboard::UpdateMaterialCBs(const GameTimer& gt)
{
...
void FBillboard::AnimateMaterials(const GameTimer& gt)
{
...
void FBillboard::UpdateMainPassCB(const GameTimer &gt)
{
...
void FBillboard::UpdateWaves(const GameTimer& gt)
{
...
void FBillboard::BuildRootSignature()
{
...
void FBillboard::BuildDescriptorHeaps()
{
	//
	// Create the SRV heap.
	//
...
void FBillboard::BuildLandGeometry()
{
...
void FBillboard::BuildWavesGeometryBuffers()
{
...
void FBillboard::BuildTreeSpritesGeometry()
{
...
void FBillboard::BuildMaterials()
{
...
void FBillboard::BuildFrameResources()
{
