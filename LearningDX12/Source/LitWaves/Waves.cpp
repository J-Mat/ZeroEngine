...
FWaves::FWaves(int m, int n, float dx, float dt, float speed, float damping)
{
    mNumRows = m;
    mNumCols = n;
...
int FWaves::RowCount()const
{
	return mNumRows;
}

int FWaves::ColumnCount()const
{
	return mNumCols;
}

int FWaves::VertexCount()const
{
	return mVertexCount;
}

int FWaves::TriangleCount()const
{
	return mTriangleCount;
}

float FWaves::Width()const
{
	return mNumCols*mSpatialStep;
}

float FWaves::Depth()const
{
...
void FWaves::Disturb(int i, int j, float magnitude)
{
